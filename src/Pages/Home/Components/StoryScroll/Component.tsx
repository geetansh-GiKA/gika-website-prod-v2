  ...
  return (
    <FlowArt aria-label="Gikagraph story">
      {sections.map(({ num, label, heading, body, img, imgCaption, bg, dark }) => {
        ...
        return (
          <FlowSection key={num} aria-label={label} style={{ backgroundColor: bg, color: text }}>
            {/* two-column grid */}
              ...
              <div className="flex flex-col justify-between px-[4vw] pt-[clamp(2rem,6vw,5rem)] pb-[4vw]">
                ...
                <div className="flex items-start gap-8">
                  ...
                  <div className="pt-2">
                    ...
                    <div className="mt-3 h-px w-8" style={{ backgroundColor: divider }} />
                  </div>
                </div>
                ...
                {/* body */}
                <div>
                  <div className="mb-6 h-px w-full" style={{ backgroundColor: divider }} />
                  <p
